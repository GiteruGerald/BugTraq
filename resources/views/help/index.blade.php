    ...
    <div class="container animated fadeIn">
        <div class="row">
            <div class="col text-center">
                <div class="h4">User Manual</div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 mx-auto mt-4">
                <div class="list-group">
                    <a href="{{ route('help.faq', ['faq' =>'project-workflow']) }}" class="list-group-item list-group-item-action">How to create a project work-flow?</a>
                    ...
                    <div class="card faq-inline" id="data-collected-text">
                        <div class="card-body">
                            <p class="mx-2 mt-2">
                                ...
                                utmost importance to us so if you have any issue, please read our.
                            </p>
                        </div>
                    </div>
